                                    ...
                                    <div className="share-image">
                                        <img
                                            src={share.property.images?.[0]
                                                ? `${share.property.images[0]?.startsWith('http') ? '' : (process.env.REACT_APP_API_BASE_URL ? process.env.REACT_APP_API_BASE_URL.replace('/api', '') : (process.env.REACT_APP_API_URL ? process.env.REACT_APP_API_URL.replace('/api', '') : 'http://localhost:4000'))}${share.property.images[0]}`
